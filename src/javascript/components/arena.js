...
export function updateHealthIndicators(firstFighter, secondFighter) {
    ...
    const firstHealthPercentage = (firstFighter.health / firstFighter.maxHealth) * 100;
    const secondHealthPercentage = (secondFighter.health / secondFighter.maxHealth) * 100;

    leftHealthBar.style.width = `${firstHealthPercentage}%`;
    rightHealthBar.style.width = `${secondHealthPercentage}%`;
}
